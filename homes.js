...
const HOMES = [
  ...
  },
  {
    ...
    zip:         "62521",
    description: "Se pedía originalmente $4,000 de enganche y $1,100/mes pero ese es mi mínimo. Prefiero $1,200/mes. Abierto a ofertas entre esos dos montos mensuales. Casa 3+1 lista para mudarse en una calle bonita, ¡no durará mucho! Distribución excelente que maximiza el espacio, la recámara principal tiene almacenaje incorporado, cocina luminosa que abre al patio, mucha luz natural. Electrodomésticos incluidos: refrigerador, estufa, microondas, lavaplatos. Patio delantero grande, patio trasero cercado. Ventanas de vinilo nuevas, piso LVP, techo de metal de 6 años, calentador de agua y aire acondicionado más nuevos. Además, losa de concreto lista para una futura ADU o garaje. Demasiadas mejoras para listar.",
    descriptionLang: "es",
    city:  "Decatur",
    state: "IL",
    beds:  3,
